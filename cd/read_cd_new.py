class read_cd():
    def __init__(self):
        ...
        fbd_data = open('big_deal.txt','r').read().split()
    ...
    def getdata(self):
        ...
        for mon in range(0,mnoth):
            ...
            file_name, cur_year, cur_month = self.get_file_name(cur_year, cur_month)
            ...
            for i in range(0,int(len(data)/16)):
                ...
                if name == "臺股期貨" and type == "A":
                    ...
                    print(count)
    def get_file_name(self, cur_year, cur_month):
        file_name = "WBOIVL3F_"
        yy = int(cur_year)
        mm = int(cur_month)
        cur_year = ""
        ...
        return filename, cur_year, cur_month